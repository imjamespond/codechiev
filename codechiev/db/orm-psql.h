...
{\
    const char* sql = "update " #table " set id=id " BOOST_PP_SEQ_FOR_EACH_I( PSQL_UPDATE, , member_seq) " where id=$" BOOST_PP_STRINGIZE(1 BOOST_PP_SEQ_FOR_EACH( TABLE_MEMBER_COUNT, , member_seq));\
